        ...
        <div class="col-md-12">
          <div class="card card-info ">
            <div class="card-header">
              <h3 class="card-title"> <li class="fas fa-check-circle"></li> Data Penerimaan Mutasi Barang</h3>
            ...
            <table id="table_kirim" class="table table-bordered table-striped ">
                  ...
                  <tbody>
                    ...
                    <tr>
                     ...
                     <td>
                      <a href="<?= base_url('spg/Mutasi/detail/'.$data->id) ?>" class="btn btn-success btn-sm"><i class="fas fa-save"></i> Proses Terima</a>
                     </td>
                     </tr>
                     <?php
                     endforeach;
