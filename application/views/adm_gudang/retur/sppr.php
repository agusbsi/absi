              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="row">
                    ...
                    <div class="col-md-9">
                    <label for="">: <?= $r->created_at?></label>
                    </div>
                    <div class="col-md-3">
                    Dari Toko
                    </div>
                    <div class="col-md-9">
                    <label for="">: <?= $r->nama_toko?></label>
                    </div>
                  </div>
                </div>
                <div class="col-md-5">
                <div class="row">
                    ...
                    <div class="col-md-6">
                    <label for=""><u>: <?= $r->tgl_jemput?></u></label>
                    </div>
                    <div class="col-md-6">
                    SPG Toko
                    </div>
                    <div class="col-md-6">
                    <label for="">: <?= $r->spg?></label>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-12 table-responsive">
                  <table  style="border: 2px solid;" >
                    ...
                    <tbody>
                    <tr>
                      <td colspan="6" class="text-center"><b>KETERANGAN</b></td>
                      </tr>
                    <tr class="text-center" >
                      ...
                      <th style="border: 2px solid;">Catatan</th>
                    </tr>
                    <?php
                            $no = 0;
                            $total = 0;
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="border: 2px solid" ><address><?= $d->keterangan ?></address></td>
                                <td style="border: 2px solid" ><address><?= $d->catatan ?></address></td>
                            </tr>
                        <?php 
                       $total += $d->qty;
                            } 
