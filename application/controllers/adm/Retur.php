...
class Retur extends CI_Controller
{
  ...
  public function index(){
    ...
    $data['list_retur'] = $this->db->query("SELECT tp.*, tk.nama_toko from tb_retur tp join tb_toko tk on tk.id = tp.id_toko where date(tp.created_at) between '$tgl_awal' and '$tgl_akhir'")->result();
